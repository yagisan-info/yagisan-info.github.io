...
const ENV = {
  ...
  'title': process.env.TITLE || 'ペットヤギの飼い方',
  'description': process.env.DESCRIPTION || `
  ヤギさんをペットとして飼うための情報を、ペットヤギ伝道師の試行錯誤を交えてお伝えします。
  ヤギの見つけ方、ミニヤギなどのヤギの種類、室内での飼い方、餌の選び方、健康管理、仕事とのやりくりなど、実際にヤギをペットとして飼う方の指針となる情報を発信していきます。
  `,
};
